...
{
    printf ("\nUsage:\n");
    printf ("%s <MINC file> <number of frames> <number of slices> ", PROGNAME);
    printf ("<height> <width> [dimension order]\n\n");

    printf ("where dimension order is one of transverse, coronal, or sagittal\n");
    printf ("and determines how slices, width, and height correspond to x, y, and z\n");
}
...
int main (int argc, char *argv[])
{
    ...
    int    num_dimensions;   /* 2, 3, or 4 based on whether frames, slices  */ 
                             /* or both are zero */
