...
workstations at PIL.  Typing \code{maple} at the shell prompt starts up
...
access to graphics.  (The easiest method is to use \code{xterm(1)} on an
...
%\subsection{A Very Brief Introduction to MATLAB, PAMI, and rCBF}

%Please consult the documents ``PAMI User Manual'' and ``rCBF Analysis
%Using MATLAB'' if you are not yet conversant with MATLAB and the PAMI
