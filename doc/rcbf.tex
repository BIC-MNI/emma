...
%
% Setup a couple of registers to hold the size of "FrameLengths: " in
% tt, so we know how much space to allocate in the description list
\newbox\holder
\setbox\holder=\hbox{\tt FrameLengths: }
\dimen0=\wd\holder
%
\begin{ttdescription}{\dimen0}
